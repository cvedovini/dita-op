...
public class BackMatterDescriptor extends TopicGroupDescriptor {

	BackMatterDescriptor() {
		super("backmatter"); //$NON-NLS-1$
	}

	@Override
	protected Descriptor[] getChildren() {
		return new Descriptor[] { Descriptor.BOOKLISTS, Descriptor.NOTICES,
				Descriptor.DEDICATION, Descriptor.COLOPHON,
				Descriptor.AMENDMENTS, Descriptor.TOPICREF,
				Descriptor.TOPICHEAD, Descriptor.TOPICGROUP };
	}
