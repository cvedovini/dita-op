...
public class TaskWizard extends AbstractNewFileWizard {
	...
	public TaskWizard() {
		super("org.dita_op.editor.template.task"); //$NON-NLS-1$
		setTitle(Messages.getString("TaskWizard.title")); //$NON-NLS-1$
		setDescription(Messages.getString("TaskWizard.description")); //$NON-NLS-1$
		setDefaultFileName("new_task.dita"); //$NON-NLS-1$
