...
public class Revprop extends AbstractProp {
	...
	public String getAttribute() {
		return "rev"; //$NON-NLS-1$
	}

	/**
	 * @return the changeBar
	 */
	...
	/**
	 * @param changeBar
	 *            the changeBar to set
	 */
	public void setChangeBar(String changeBar) {
		String oldChangeBar = this.changeBar;
		this.changeBar = changeBar;
		firePropertyChanged("changeBar", oldChangeBar, changeBar); //$NON-NLS-1$
	}
