...
import org.dita_op.editor.internal.ui.editors.model.AbstractProp;
...
public class PropsMasterSection extends SectionPart {
	...
	private final Action addRevpropAction = new Action(Messages.getString("PropsMasterSection.addProp.menu"), //$NON-NLS-1$
