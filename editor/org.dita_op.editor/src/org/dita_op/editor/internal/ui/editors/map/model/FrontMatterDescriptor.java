...
public class FrontMatterDescriptor extends TopicGroupDescriptor {
	...
	protected Descriptor[] getChildren() {
		return new Descriptor[] { Descriptor.BOOKLISTS, Descriptor.NOTICES,
				...
				Descriptor.BOOKABSTRACT, Descriptor.DRAFTINTRO,
				Descriptor.PREFACE, Descriptor.TOPICREF, Descriptor.TOPICHEAD,
				Descriptor.TOPICGROUP };
	}
