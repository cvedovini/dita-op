...
public class MapWizard extends AbstractNewFileWizard {
	...
	public MapWizard() {
		super("org.dita_op.editor.template.map"); //$NON-NLS-1$
		setTitle(Messages.getString("MapWizard.title")); //$NON-NLS-1$
		setDescription(Messages.getString("MapWizard.description")); //$NON-NLS-1$
		setDefaultFileName("new_map.ditamap"); //$NON-NLS-1$
		setFileExtension("ditamap"); //$NON-NLS-1$
	}
