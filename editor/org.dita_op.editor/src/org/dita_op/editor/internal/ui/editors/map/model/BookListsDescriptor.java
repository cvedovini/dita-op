...
public class BookListsDescriptor extends TopicGroupDescriptor {

	BookListsDescriptor() {
		super("booklists"); //$NON-NLS-1$
	}

	@Override
	protected Descriptor[] getChildren() {
		return new Descriptor[] { Descriptor.TOC, Descriptor.FIGURELIST,
				Descriptor.ABBREVLIST, Descriptor.TRADEMARKLIST,
				Descriptor.BIBLIOLIST, Descriptor.GLOSSARYLIST,
				Descriptor.INDEXLIST, Descriptor.BOOKLIST };
	}
