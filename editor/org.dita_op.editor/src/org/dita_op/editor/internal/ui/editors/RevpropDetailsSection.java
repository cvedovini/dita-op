...
public class RevpropDetailsSection extends AbstractFormPart implements
	...
	protected void createClientArea(Composite parent, FormToolkit toolkit) {
		...
		toolkit.createLabel(parent, Messages.getString("RevpropDetailsSection.action.label")); //$NON-NLS-1$
		...
		toolkit.createLabel(parent, Messages.getString("RevpropDetailsSection.value.label")); //$NON-NLS-1$
		...
		toolkit.createLabel(parent, Messages.getString("RevpropDetailsSection.changebar.label")); //$NON-NLS-1$
		...
		toolkit.createLabel(parent, Messages.getString("RevpropDetailsSection.style.label")); //$NON-NLS-1$
