...
public class PropDetailsSection extends AbstractFormPart implements
	...
	protected void createClientArea(Composite parent, FormToolkit toolkit) {
		...
		toolkit.createLabel(parent, Messages.getString("PropDetailsSection.action.label")); //$NON-NLS-1$
		...
		toolkit.createLabel(parent, Messages.getString("PropDetailsSection.attribute.label")); //$NON-NLS-1$
		...
		toolkit.createLabel(parent, Messages.getString("PropDetailsSection.value.label")); //$NON-NLS-1$
		...
		toolkit.createLabel(parent, Messages.getString("PropDetailsSection.style.label")); //$NON-NLS-1$
