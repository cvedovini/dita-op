...
public class ConceptWizard extends AbstractNewFileWizard {
	...
	public ConceptWizard() {
		super("org.dita_op.editor.template.concept"); //$NON-NLS-1$
		setTitle(Messages.getString("ConceptWizard.title")); //$NON-NLS-1$
		setDescription(Messages.getString("ConceptWizard.description")); //$NON-NLS-1$
		setDefaultFileName("new_concept.dita"); //$NON-NLS-1$
