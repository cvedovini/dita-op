...
public class ReferenceWizard extends AbstractNewFileWizard {
	...
	public ReferenceWizard() {
		super("org.dita_op.editor.template.reference"); //$NON-NLS-1$
		setTitle(Messages.getString("ReferenceWizard.title")); //$NON-NLS-1$
		setDescription(Messages.getString("ReferenceWizard.description")); //$NON-NLS-1$
		setDefaultFileName("new_reference.dita"); //$NON-NLS-1$
		setFileExtension("dita"); //$NON-NLS-1$
	}
